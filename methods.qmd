...
1)  [Biophysical Settings (BpS) Models, Documents and Reference Condition tables](https://landfire.gov/bps-models.php){target='blank'}: For estimating "reference" (historic) amounts of open- and closed late-succession classes.
2)  [Biophysical Settings Spatial Data](https://landfire.gov/bps.php){target='blank'}: Were used to map 'ecosystem footprints'. 
3)  [Succession Class Spatial Data](https://landfire.gov/sclass.php){target='blank'}: To create a map of current succession classes.  These are linked to the BpS products. 
...
We relied on LANDFIRE's [Biophysical Settings (BpS)](https://landfire.gov/bps.php){target='blank'} to obtain "potential ecosystem footprints" to represent what would have been present prior to European colonization of North America. LANDFIRE's BpS suite is based on both the current biophysical environment and an approximation of the historical disturbance regime. 
...
1. The BpS Reference Condition Table obtainable by clicking "Reference Conditions" [here](https://landfire.gov/bps-models.php){target='blank'}.
...
We used the LANDFIRE [succession class dataset](https://landfire.gov/sclass.php){target='blank'} to estimate the percentage of each succession class that occurs (per BpS) on today's landscape. Each pixel within a BpS is labeled "A through E" for the "reference" states, and includes labels for other categories such as agriculture and urban. 
...
The rules for defining the structural characteristics of each succession class are in the [BpS descriptions](https://www.landfire.gov/bps-models.php){target='blank'}, and are essentially combinations of height, cover and type. 
