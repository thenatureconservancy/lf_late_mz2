...
```{r stacked bps, message=FALSE, echo=FALSE, warning=FALSE, fig.width=9, fig.height=16}
...
The map below represents the reference and current percentages of late-successional forest by ecosystem. In general there has been a substantial loss of late-successional habitat in this area. 


![Map of historic percentages of late successional forest. We used quantiles for the legend breaks. Percent late-successional forest was joined to the BpS data as an attribute in GIS ](assets/ref_cur_late.jpg){width=80%}
