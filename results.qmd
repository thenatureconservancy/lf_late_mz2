...
```{r stacked bps, message=FALSE, warning=FALSE, fig.width=9, fig.height=10}
...
```{r late-succession change, message=FALSE, warning=FALSE, fig.width=9, fig.height=8}
...
```{r late-succession change, open and closed, message=FALSE, warning=FALSE, fig.width=9, fig.height=9}
